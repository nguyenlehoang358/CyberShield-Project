...
const TABLES = [
    ...
    {
        id: 'blog_posts', name: 'blog_posts', color: '#00FF9D', // Bright Green/Safe
        fields: [
            { name: 'id', type: 'BIGINT', pk: true },
    ...
    {
        id: 'contact_messages', name: 'contact_messages', color: '#03E08A', // Teal
        fields: [
            { name: 'id', type: 'BIGINT', pk: true },
...
const INITIAL_POSITIONS = {
    ...
    blog_posts: { x: 760, y: 260 },
    contact_messages: { x: 60, y: 780 },
