                            ...
                            <div className="tab-pane">
                                ...
                                <div className="dash-card">
                                    ...
                                    <div style={{display:'flex', flexDirection:'column', alignItems:'center', padding:'2.5rem 0', color:'#9ca3af', textAlign:'center'}}>
                                        <div style={{width:'4rem', height:'4rem', borderRadius:'50%', background:'rgba(255,255,255,0.05)', border:'1px solid rgba(255,255,255,0.1)', display:'flex', alignItems:'center', justifyContent:'center', marginBottom:'1rem'}}>
                                            <Activity size={24} />
                                        </div>
                            ...
                            <div className="tab-pane">
                                <div className="dash-card">
                                    ...
                                    <div className="mfa-status-box">
                                        ...
                                        {user?.mfaEnabled && (
                                            <div style={{padding:'0.5rem 1rem', background:'rgba(255,255,255,0.05)', borderRadius:'0.5rem', border:'1px solid rgba(255,255,255,0.1)', fontSize:'0.875rem'}}>
                                                Được quản lý
                                            </div>
                                        )}
                                    </div>
                                ...
                                <div className="dash-card" style={{display:'flex', gap:'1rem', alignItems:'flex-start'}}>
                                    ...
                                    <div>
                                        ...
                                        <button style={{padding:'0.5rem 1.25rem', borderRadius:'0.5rem', border:'1px solid rgba(255,255,255,0.2)', background:'transparent', color:'white', cursor:'pointer', fontSize:'0.875rem', fontWeight:500}}>Đổi mật khẩu</button>
                                    </div>
                                </div>
                            </div>
                        )}
                                        ...
                                        <div className="linked-account-item">
                                            <div className="linked-account-info">
                                                ...
                                                <div>
                                                    ...
                                                    <p style={{fontSize:'0.875rem', color:'#6b7280'}}>Chưa liên kết</p>
                                                </div>
                                            </div>
                                            <button style={{padding:'0.5rem 1rem', borderRadius:'0.5rem', background:'rgba(255,255,255,0.1)', color:'white', border:'1px solid rgba(255,255,255,0.1)', cursor:'pointer', fontSize:'0.875rem', fontWeight:500}}>
                                                Liên kết ngay
                                            </button>
                                        </div>
