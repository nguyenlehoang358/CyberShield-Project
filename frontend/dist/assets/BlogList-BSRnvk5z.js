import{c,j as e,U as s,L as i,A as r}from"./index-BthK2BC8.js";const a=c("Calendar",[["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",ry:"2",key:"eu3xkr"}],["line",{x1:"16",x2:"16",y1:"2",y2:"6",key:"m3sa8f"}],["line",{x1:"8",x2:"8",y1:"2",y2:"6",key:"18kwsl"}],["line",{x1:"3",x2:"21",y1:"10",y2:"10",key:"xt86sb"}]]),o=c("Tag",[["path",{d:"M12 2H2v10l9.29 9.29c.94.94 2.48.94 3.42 0l6.58-6.58c.94-.94.94-2.48 0-3.42L12 2Z",key:"14b2ls"}],["path",{d:"M7 7h.01",key:"7u93v4"}]]),h=[{id:"security-101",title:"Nhập môn An toàn thông tin: Bắt đầu từ đâu?",desc:"Hướng dẫn lộ trình học cybersecurity cho người mới bắt đầu. Các chứng chỉ cần thiết và kỹ năng nền tảng.",author:"Admin",date:"2024-02-15",tags:["Beginner","Career"],content:`
...
4. **Limit Resources**
   Set CPU/Memory limits để tránh DoS attack từ bên trong container.
        `}];function l(t){try{return new Date(t).toLocaleDateString()}catch{return t}}function d(){return e.jsxs("div",{className:"eco-container",children:[e.jsxs("header",{style:{marginBottom:"3rem",textAlign:"center"},children:[e.jsx("h1",{className:"eco-title-gradient",children:"Knowledge Base"}),e.jsx("p",{className:"eco-subtitle",children:"Chia sẻ kiến thức về An toàn thông tin, DevOps và lập trình."})]}),e.jsx("div",{className:"blog-grid",children:h.map(t=>e.jsx("article",{className:"blog-card",children:e.jsxs("div",{className:"blog-content",children:[e.jsxs("div",{className:"blog-meta",children:[e.jsx(a,{size:14})," ",l(t.date),e.jsx("span",{children:"•"}),e.jsx(s,{size:14})," ",t.author]}),e.jsx("h2",{className:"blog-title",children:e.jsx(i,{to:`/blog/${t.id}`,style:{color:"inherit",textDecoration:"none"},children:t.title})}),e.jsx("p",{className:"blog-excerpt",children:t.desc}),e.jsxs("div",{className:"blog-footer",children:[e.jsx("div",{className:"blog-tags",children:t.tags.slice(0,2).map(n=>e.jsxs("span",{className:"blog-tag",children:[e.jsx(o,{size:10,style:{marginRight:"4px"}})," ",n]},n))}),e.jsxs(i,{to:`/blog/${t.id}`,className:"blog-link",children:["Read ",e.jsx(r,{size:14})]})]})]})},t.id))})]})}export{d as default};
